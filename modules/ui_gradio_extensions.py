...
def javascript_html():
    ...
    studio_autofill_bridge_js_path = webpath('javascript/studio-autofill-bridge.js')
    ...
    head += f'<script type="text/javascript" src="{studio_autofill_bridge_js_path}"></script>\n'
